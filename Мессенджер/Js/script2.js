            ...
            Chatdata.forEach(element => {
                ...
                if (!block_chats) {
                    ...
                    // })
                        ...
                        _elem(`#chat_${element.chat_id}`).addEventListener('click', function () {
                            if(_elem(`#chat_${element.chat_id}`).classList.contains('chat-alert')){
                                block_chats.classList.remove('chat-alert')
                            }
                            // block_chats.classList.remove('chat-alert')
...
function createChatBlock(chatdata) {
    ...
    chatBlock.onclick = function () {
        ...
        // let getChatId = document.querySelector(`#chat_${CURRENT_CHAT}`)
        // if(getChatId){
        //     getChatId.classList.remove('active')
        // }
        // document.querySelectorAll('.block_chats').forEach(element=>{
        ...
        //         // document.getElementById(`#chat_${chatdata.chat_id}`).classList.remove('active');
        //     }
        //     );
        // } else {
        //     // document.getElementById(`chat_${chatdata.chat_id}`).classList.remove('active');
        ...
        // if(chatBlock.id!=localStorage.getItem('_chatID')){
        //     document.getElementById(`chat_${CURRENT_CHAT}`).classList.remove('active')
        // }


        // if(CURRENT_CHAT = localStorage.getItem('_chatID')){
        //     document.getElementById(`chat_${chatdata.chat_id}`).classList.add('active')
        // }
        // else{
        //     if(CURRENT_CHAT !=localStorage.getItem('_chatID')){
        //         _elem('.block_chats').forEach(element => {
        //             element.classList.remove('active')
        //         });
        //     }
        // }
        ...
        // chatBlock.forEach(element=>{
        //     if(chatdata.chat_id!=localStorage.getItem('_chatID')){
        //         element.classList.remove('active')
        //     }
        // })
        ...
        // if(localStorage.getItem('_chatID')=chatdata.chat_id){
        //     clearInterval(TIMER_BLINK_CHAT)
        // }
...
//     CURRENT_CHAT = newID
//     const newElement = document.querySelector(`#chat_${CURRENT_CHAT}`)
//     if(newElement){
